...
from agente_ciar.cache.consultas import guardar as guardar_cache
from agente_ciar.config.settings import booleano
from agente_ciar.grafo.estado import EstadoAgente
from agente_ciar.llm.fabrica import obtener_llm
from agente_ciar.memoria.bloques import registrar_mensaje
from agente_ciar.memoria.conversacional import actualizar_entidades, formatear
...
def _limpieza_turno() -> dict[str, Any]:
    """Retira datos pesados o transitorios antes de guardar el checkpoint conversacional."""
    return {
        "schema_texto": None,
        "filas": [],
        "entidades": [],
